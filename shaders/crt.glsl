...
const float ABBERATION_FACTOR = 0.00;    // Reduced strength of color splitting effect
...
const float BRIGHT_BOOST = 1.1;          // Brightness multiplier for bright pixels
const float DIM_GLOW = 0.03;             // Glow intensity for dim pixels
const float BRIGHT_GLOW = 0.04;          // Glow intensity for bright pixels
